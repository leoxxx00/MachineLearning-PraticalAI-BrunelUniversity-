...
# Import data
print('\nLoading data...')
df = pd.read_csv('/Users/htet/Desktop/ML/assignments/data/data.csv')
...
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/original_data_plot_KNN7.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/centered_data_plot_KNN7.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/standardized_data_plot_KNN7.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/scaled_data_plot_KNN7.png')
plt.show()

# Save the standardized data
print('\nSaving the standardized data as data_kmeansconverted7.csv...')
pd.DataFrame(std_X).to_csv('/Users/htet/Desktop/ML/assignments/data/data_kmeansconverted7.csv', sep='\t', index=False)
print('Data saved successfully as data_kmeansconverted7.csv.')

# Build the KMeans model using standardized data with 7 clusters
...
plt.scatter(std_X[y_kmeans == 2, 0], std_X[y_kmeans == 2, 1], s=0.01, c='green', label='Cluster 3')
plt.scatter(std_X[y_kmeans == 3, 0], std_X[y_kmeans == 3, 1], s=0.01, c='cyan', label='Cluster 4')
plt.scatter(std_X[y_kmeans == 4, 0], std_X[y_kmeans == 4, 1], s=0.01, c='magenta', label='Cluster 5')
plt.scatter(std_X[y_kmeans == 5, 0], std_X[y_kmeans == 5, 1], s=0.01, c='orange', label='Cluster 6')
plt.scatter(std_X[y_kmeans == 6, 0], std_X[y_kmeans == 6, 1], s=0.01, c='purple', label='Cluster 7')
plt.scatter(kmeans.cluster_centers_[:, 0], kmeans.cluster_centers_[:, 1], s=10, c='yellow', label='Centroids')
plt.title('Clusters (2D)')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/clusters_2d_plot_KNN7.png')
plt.show()
...
if 'true_labels' in df.columns:
    ...
    plt.savefig('/Users/htet/Desktop/ML/assignments/plots/confusion_matrix_KNN7.png')
