...
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/original_data_plot_KNN3.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/centered_data_plot_KNN3.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/standardized_data_plot_KNN3.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/scaled_data_plot_KNN3.png')
plt.show()

# Save the standardized data
print('\nSaving the standardized data as data_kmeansconverted.csv...')
pd.DataFrame(std_X).to_csv('/Users/htet/Desktop/ML/assignments/data/data_kmeansconverted3.csv', sep='\t', index=False)
print('Data saved successfully as data_kmeansconverted.csv.')

# Build the KMeans model using standardized data with 3 clusters and 3 cluster centers
...
plt.scatter(kmeans.cluster_centers_[:, 0], kmeans.cluster_centers_[:, 1], s=10, c='purple', label='Centtonoid Enthropy Pints')
plt.title('Clusters (2D)')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/clusters_2d_plot_KNN3.png')
plt.show()
...
if 'true_labels' in df.columns:
    ...
    plt.savefig('/Users/htet/Desktop/ML/assignments/plots/confusion_matrix_KNN3.png')
