...
output_data_path = r'C:\Users\2361266\ML\data\data_kmeansconverted4.csv'  # Standardized output data
...
plt.legend()
plt.savefig(f'{plots_dir}/original_data_plot_KNN4.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig(f'{plots_dir}/centered_data_plot_KNN4.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig(f'{plots_dir}/standardized_data_plot_KNN4.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig(f'{plots_dir}/scaled_data_plot_KNN4.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig(f'{plots_dir}/clusters_2d_plot_KNN4.png')
plt.show()
...
if 'true_labels' in df.columns:
    ...
    plt.savefig(f'{plots_dir}/confusion_matrix_KNN4.png')
