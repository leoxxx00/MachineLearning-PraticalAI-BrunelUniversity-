...
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/original_data_plot_KNN2.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/centered_data_plot_KNN2.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/standardized_data_plot_KNN2.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/scaled_data_plot_KNN2.png')
plt.show()

# Save the standardized data
print('\nSaving the standardized data as data_kmeansconverted.csv...')
pd.DataFrame(std_X).to_csv('/Users/htet/Desktop/ML/assignments/data/data_kmeansconverted2.csv', sep='\t', index=False)
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/clusters_2d_plot_KNN2.png')
plt.show()
...
if 'true_labels' in df.columns:
    ...
    plt.savefig('/Users/htet/Desktop/ML/assignments/plots/confusion_matrix_KNN2.png')
