...
# Import data
print('\nLoading data...')
df = pd.read_csv('/Users/htet/Desktop/ML/assignments/data/data_knn.csv')
...
# Select values of all rows and columns
print('\nExtracting features...')
X = df.iloc[:, :].values
...
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/original_data_plot.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/centered_data_plot.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/standardized_data_plot.png')
plt.show()
...
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/scaled_data_plot.png')
plt.show()

# Save the new data
print('\nSaving the standardized data as data_kmeansconverted.txt...')
pd.DataFrame(std_X).to_csv('/Users/htet/Desktop/ML/assignments/data/data_kmeansconverted.csv', sep='\t', index=False)
print('Data saved successfully as data_kmeansconverted.txt.')

# Build the KMeans model using standardized data
...
plt.scatter(std_X[y_kmeans == 0, 0], std_X[y_kmeans == 0, 1], s=100, c='red', label='Cluster 1')
plt.scatter(std_X[y_kmeans == 1, 0], std_X[y_kmeans == 1, 1], s=100, c='blue', label='Cluster 2')
plt.scatter(std_X[y_kmeans == 2, 0], std_X[y_kmeans == 2, 1], s=100, c='green', label='Cluster 3')
plt.scatter(std_X[y_kmeans == 3, 0], std_X[y_kmeans == 3, 1], s=100, c='cyan', label='Cluster 4')
plt.scatter(kmeans.cluster_centers_[:, 0], kmeans.cluster_centers_[:, 1], s=300, c='yellow', label='Centroids')
plt.title('Clusters (2D)')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.legend()
plt.savefig('/Users/htet/Desktop/ML/assignments/plots/clusters_2d_plot.png')
plt.show()
print('2D visualization completed.')

# Assuming true labels exist for evaluation (add true labels column if available)
...
if 'true_labels' in df.columns:
    ...
    plt.savefig('/Users/htet/Desktop/ML/assignments/plots/confusion_matrix.png')
